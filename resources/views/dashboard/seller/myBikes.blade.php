...
<div class="mb-5 col-md-12">
    <div class="table-responsive">
        <div class="table-header-panel">
            <div class="d-flex">
                <div class="first">
                    <h2 class="text-uppercase title-2">My Bikes</h2>
                </div>
                <div class="align-self-center text-right second">
                    <a class="btn_dashboard py-3"  href="{{ route('seller.bikes.add') }}"> Add New</a>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($row->fea_image != null)
                                    <img src="{{ asset('storage/' . $row->fea_image) }}" alt="plus-circle" width="70px"
                            ...
                            <td>
                                <a href="{{ route('seller.bikes.edit', $row->id) }}"
                                    class="btn btn-primary btn-sm mt-2"><i class="fa fa-info"
                                        style="font-size:18px"></i></a>
                                <a href="{{ route('seller.bikes.del', $row->id) }}" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger btn-sm mt-2"><i class="fa fa-trash"
                                        style="font-size:18px"></i></a>
                            </td>
                        </tr>
                    @endforeach
