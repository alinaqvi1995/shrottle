...
<div class="mb-5 col-md-12">
    <div class="table-responsive">
        <div class="table-header-panel">
            <div class="d-flex">
                <div class="first">
                    <h2 class="text-uppercase title-2">All FAQs</h2>
                </div>
                <div class="align-self-center text-right second">
                    <a class="btn btn-primary" style="color:#FFF;" href="{{ route('admin.faqs.add') }}"> Add New Question</a>
                </div>
            </div>
        </div>
                ...
                @if (count($faqs) > 0)
                    @foreach ($faqs as $key => $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.faqs.edit', $row->id) }}" class="btn btn-primary btn-sm mt-2"><i class="fa fa-info"
