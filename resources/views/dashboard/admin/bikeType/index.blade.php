    ...
    <div class="mb-5 col-md-12">
        <div class="table-responsive">
            <div class="table-header-panel">
                <div class="d-flex">
                    <div class="first">
                        <h2 class="text-uppercase title-2">All Bike Types</h2>
                    </div>
                    <div class="align-self-center text-right second">
                        <a class="btn btn-primary" style="color:#FFF;" href="{{ route('admin.type.add') }}"> Add New</a>
                    </div>
                </div>
            </div>
                    ...
                    @if (count($type) > 0)
                        @foreach ($type as $key => $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.type.edit', $row->id) }}" class="btn btn-primary btn-sm mt-2"><i class="fa fa-info"
