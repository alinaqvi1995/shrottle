    ...
    <div class="mb-5 col-md-12">
        <div class="table-responsive">
            <div class="table-header-panel">
                <div class="d-flex">
                    <div class="first">
                        <h2 class="text-uppercase title-2">All Testimonials</h2>
                    </div>
                    <div class="align-self-center text-right second">
                        <a class="btn btn-primary" style="color:#FFF;" href="{{ route('admin.test.add') }}"> Add New</a>
                    </div>
                </div>
            </div>
                    ...
                    @if (count($cust) > 0)
                        @foreach ($cust as $key => $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.test.edit', $row->id) }}"
