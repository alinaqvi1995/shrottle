                    ...
                    <div class="table table-border table-responsive">
                        <div class="table-header-panel">
                            <div class="d-flex">
                                <div class="first">
                                    ...
                                    <h1 class="text-uppercase title-2">Bike Leads</h1>
                                </div>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>{{ $row->user->buyer->country_code }} {{ $row->user->buyer->phone }}</td>
                                {{-- <td>{{ $row->message }}</td> --}}
                                <td>
                                    <a href="{{ route('admin.leadBike.details', $row->id) }}" class="btn btn-primary btn-sm mt-2"><i
                                        class="fa fa-info" style="font-size:18px"></i></a>
                                    <a href="{{ route('admin.leadBike.delete', $row->id) }}" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger btn-sm mt-2"><i
