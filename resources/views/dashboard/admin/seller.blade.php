                    ...
                    <div class="table-header-panel">
                        <div class="d-flex">
                            <div class="first">
                                ...
                                <h1 class="text-uppercase title-2">Vendors</h1>
                            </div>
                        ...
                        @if (count($seller) > 0)
                            @foreach ($seller as $key => $row)
                                <tr>
                                    ...
                                    <td>
                                        @if ($row->avatar != null)
                                            <img src="{{ asset('storage/' . $row->avatar) }}" alt="plus-circle"
                                    ...
                                    <td>
                                        <a href="{{ route('admin.seller.details', $row->id) }}"
                                            class="btn btn-primary btn-sm mt-2"><i class="fa fa-info"
                                                style="font-size:18px"></i></a>
                                        <a href="" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger btn-sm mt-2"><i class="fa fa-trash"
                                                style="font-size:18px"></i></a>
                                    </td>
                                </tr>
                            @endforeach
