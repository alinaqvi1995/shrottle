@extends('dashboard.admin.layout.app') @section('page_title', 'Shrottle - Rent A Bike') @section('head_style')
<!-- Ionicons -->
...
<div class="col-xl-4 col-md-6 d-flex mb-5">
    <div class="card dashboard-card bg-one">
        <div class="card-body d-flex align-items-center">
            ...
            <div class="second">
                <h5 class="card-title">{{ $totalBikes }}</h5>
...
<div class="col-xl-4 col-md-6 d-flex mb-5">
    <div class="card dashboard-card bg-two">
        <div class="card-body d-flex align-items-center">
            ...
            <div class="second">
                <h5 class="card-title">{{ $totalSellers }}</h5>
...
<div class="col-xl-4 col-md-6 d-flex mb-5">
    <div class="card dashboard-card bg-three">
        <div class="card-body d-flex align-items-center">
            ...
            <div class="second">
                <h5 class="card-title">{{ $totalBuyers }}</h5>
        ...
        <div class="table-header-panel">
            <div class="d-flex">
                ...
                <div class="align-self-center text-right second">
                    <a class="btn btn-primary" style="color:#FFF;" href="{{ route('admin.leadBike') }}"> View All</a>
                </div>
            </div>
        </div>
