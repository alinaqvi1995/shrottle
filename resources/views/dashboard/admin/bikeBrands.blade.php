...
<div class="mb-5 col-md-12">
    <div class="table-responsive">
        <div class="table-header-panel">
            <div class="d-flex">
                <div class="first">
                    <h2 class="text-uppercase title-2">All Brands</h2>
                </div>
                <div class="align-self-center text-right second">
                    <a class="btn btn-primary" style="color:#FFF;" href="{{ route('admin.brand.add') }}"> Add New Brand</a>
                </div>
            </div>
        </div>
                ...
                @if (count($brand) > 0)
                    @foreach ($brand as $key => $row)
                        <tr>
                            ...
                            <td>
                                @if ($row->image != null)
                                    <img src="{{ asset('storage/' . $row->image) }}" alt="plus-circle" width="70px"
