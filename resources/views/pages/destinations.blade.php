        ...
        <section class="inner-banner text-center text-uppercase ">
            <div class="container">
                <div class="row pt-12 pt-sm-12 align-items-center justify-content-center">
                    <div class="col">
                        <h1 class="fs-1 fw-bold">All Destinations</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-md-2">
                    ...
                    <div class="col mb-4 mb-md-0">
                        <a class="box" href="{{ route('bike.list', $row->id) }}">
                            <img src="{{ asset('storage/' . $row->fea_image) }}" alt="" class="img-fluid w-100 mh-100" style="height: 423.79px">
                            <p class="mb-0 text-center text-darke bg-yellow fs-1 py-3">{{ $row->bike_state->name }}</p>
                        </a>
                    </div>
                    {{-- <div class="col">
                        <a class="box" href="#">
